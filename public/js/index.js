...
$(document).ready(function () {
    ...
    $("header nav ul li:nth-child(2)").click(function () {
        if ($searchSection.css("display") === "none") {
            ...
            replaceIconSrc($searchIcon, "public/img/icons/search.png");
            $searchSection.fadeOut(100).css("display", "flex");
        }
        if ($menuIcon.attr("src") === "public/img/icons/cancel.png") {
            replaceIconSrc($menuIcon, "public/img/icons/menu.png");
            $menuSection.hide();
        }
    });
    ...
    $("header nav ul li:nth-child(3)").click(function () {
        ...
        if ($searchIcon.attr("src") === "public/img/icons/cancel.png") {
            replaceIconSrc($searchIcon, "public/img/icons/search.png");
            $searchSection.hide();
        }
    });
